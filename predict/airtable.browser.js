...
})()(
  {
      ...
      function (require, module, exports) {
        ...
        var browserGlobal =
          typeof window !== "undefined"
            ...
            ? self
            : null; // self is the global in web workers
        if (!browserGlobal) {
      ...
      function (require, module, exports) {
        ...
        var browserGlobal =
          typeof window !== "undefined"
            ...
            ? self
            : null; // self is the global in web workers
        module.exports = !browserGlobal
          ? node_fetch_1.default
          : browserGlobal.fetch.bind(browserGlobal);
      },
      { "node-fetch": 20 },
    ],
    8: [
    ...
    13: [
      function (require, module, exports) {
        ...
        function eachPage(pageCallback, done) {
          ...
          var pathAndParamsAsString =
            "/" +
            this._table._urlEncodedNameOrId() +
            "?" +
            object_to_query_param_string_1.default(params);
          var queryParams = {};
          ...
          if (
            params.method === "post" ||
            pathAndParamsAsString.length >
              query_params_1.URL_CHARACTER_LENGTH_LIMIT
          ) {
            ...
            for (
              var _i = 0, paramNames_1 = paramNames;
              _i < paramNames_1.length;
              _i++
            ) {
              var paramName = paramNames_1[_i];
              if (
                query_params_1.shouldListRecordsParamBePassedAsParameter(
                  paramName
                )
              ) {
    ...
    14: [
      function (require, module, exports) {
        ...
        exports.shouldListRecordsParamBePassedAsParameter =
          exports.URL_CHARACTER_LENGTH_LIMIT =
        ...
        exports.paramValidators = {
          ...
          method: typecheck_1.default(function (method) {
            return (
              isString_1.default(method) && ["get", "post"].includes(method)
            );
          }, 'the value for `method` should be "get" or "post"'),
          returnFieldsByFieldId: typecheck_1.default(
            isBoolean_1.default,
            "the value for `returnFieldsByFieldId` should be a boolean"
          ),
        };
        exports.URL_CHARACTER_LENGTH_LIMIT = 15000;
        exports.shouldListRecordsParamBePassedAsParameter = function (
          paramName
        ) {
    ...
    17: [
      function (require, module, exports) {
        ...
        var Table = /** @class */ (function () {
          ...
          Table.prototype._listRecords = function (
            pageSize,
            offset,
            opts,
            done
            ...
            var pathAndParamsAsString =
              ...
              this._urlEncodedNameOrId() +
              "?" +
              object_to_query_param_string_1.default(opts);
            var path;
            ...
            if (
              ...
              listRecordsData = __assign(
                __assign({}, pageSize && { pageSize: pageSize }),
